...
describe("Status page", () => {
  ...
  it("Should check validation form", () => {
    ...
    statusPage.getZIPPostalCode("12345678877786785858758757858");
    statusPage.getPhone("+3809");
    //valid data
    statusPage.getZIPPostalCode("2345678");
    statusPage.getPhone("+380978654896");
    statusPage.getRegistrationNumber("12512512512512512515215251255252");
    statusPage.getSubmitBtn().click();
    cy.wait(1000);
    statusPage.getCurrentPassword("Tt12345678");
    //statusPage.getClickHere().should('include','https://www.access.fda.gov/oaa/createNewAccountflow.htm?execution=e1s1')
    statusPage.getConfirmBtn().first().click();
    statusPage.getSaveBtn().last().click();
  });
});
