...
describe('Subcribe page', () => {
    ...
    it('Should check data subscribe page and subscribe business page ', () => {
        ...
        //write valid 
         ...
         subscribepage  
         .getFirstName('Valentyn1234567891011121314151617181920212223242526272829303132343536373839404142')
         subscribepage  .getInvalidFeedbackFirstName()
         .should('have.text','First Name required, at least 1 and no more than 50 characters')
         subscribepage  
         .getLastName('Marynchyk1234567891011121314151617181920212223242526272829303132343536373839404142')
         subscribepage  
         .getInvalidFeedbackLastName()
         .should('have.text','Last Name required, at least 1 and no more than 50 characters')
         subscribepage  
         ...
         //write valid dates
         subscribepage  
         .getFirstName('Valentyn')
         subscribepage 
         .getLastName('Marynchyk')
         subscribepage  
         .getSubscribeFormBtn()
        ...
        subscribebusiness   
            .getProducerTitle()
            .should('have.text','Producer')
        subscribebusiness   
            .getProducerSubmit()
            .should('be.enabled')
        subscribebusiness   
            .getMerchantTitle()
            .should('have.text','Merchant')
        subscribebusiness   
            .getMerchantSubmit()
            .should('be.enabled')
        subscribebusiness
            .getShipperTitle()
            .should('have.text','Shipper')
        subscribebusiness   
            .getShipperSubmit()
            .should('be.enabled')
        subscribebusiness   
